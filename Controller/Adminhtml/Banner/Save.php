 ...
 */
class Save extends \Acx\Slider\Controller\Adminhtml\Banner
{
    /**
            ...
            if ($imageRequest && strlen($fileName)) {
                ...
                try {
                    ...
                    $result = $uploader->save(
                        $mediaDirectory->getAbsolutePath(\Acx\Slider\Model\Banner::BASE_MEDIA_PATH)
                    );
                    $data['image'] = \Acx\Slider\Model\Banner::BASE_MEDIA_PATH.$result['file'];
                } catch (\Exception $e) {
                    if ($e->getCode() == 0) {
